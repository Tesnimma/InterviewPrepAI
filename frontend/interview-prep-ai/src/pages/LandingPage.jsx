  ...
  return (
    <>
      <div className="w-full min-h-full bg-[#FFFCEF] relative">
        ...
        <div className="w-[500px] h-[500px] bg-amber-200/20 blur-[650px] absolute top-0 left-0"></div>

        {/* Main content */}
        <div className="container mx-auto px-4 pt-6 pb-[200px] relative z-10">
          {/* HEADER */}
          <header className="flex justify-between items-center mb-16 mr-10 ml-10">
          ...
          {/* HERO SECTION */}
          <div className="flex flex-col md:flex-row items-center mr-10 ml-10">
            {/* LEFT SIDE */}
            <div className="w-full md:w-1/2 mb-10 md:mb-0">
              <div className="flex items-center justify-left mb-2">
                <div className="flex items-center gap-2 text-[13px] text-amber-600 font-semibold bg-amber-100 px-3 py-1 rounded-full border border-amber-300">
                  <LuSparkles className="text-amber-600" /> AI Powered
                </div>
              </div>
